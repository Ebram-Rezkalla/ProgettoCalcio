...
public class FilterCompetizione extends StatsCompetizione {
	 ...
	 * 2) id della competizione desiderata
	 * 3) il numero desiderata di squadre 
...
// metodo che verifica la correttezza del numero di squadre inserito dall'utente
public void VerificaNumero(int n) {
    ...
    /*metodo che verifica la correttezza del tipo di filter inserito dall'utente
